...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // publier_projet
        if ($pathinfo === '/publier_projet') {
            return array (  '_controller' => 'Crowd\\CrowdRiseBundle\\Controller\\CrowdController::publier_projetAction',  '_route' => 'publier_projet',);
        }

        // connecte
        if ($pathinfo === '/connecte') {
            return array (  '_controller' => 'Crowd\\CrowdRiseBundle\\Controller\\CrowdController::connecteAction',  '_route' => 'connecte',);
        }
